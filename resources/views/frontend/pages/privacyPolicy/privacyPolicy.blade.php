	...
	<div class="row justify-content-row">
		<div class="col-sm-10 col-md-10 col-lg-10">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12">
					@php
					 $horizontal7 = DB::table('ads')->where('type',2)->skip(7)->first();
					@endphp
					<div class="sidebar-add">
						<a href="{{$horizontal7->link}}" target="_blank">
						  <img src="{{asset($horizontal7->ads)}}" alt="$horizontal7->link" />
						</a>
					</div>
				</div>
			</div><!-- /.add-close -->
			...
			<div class="row">
				<div class="col-md-12 col-sm-12">
					@php
					 $horizontal8 = DB::table('ads')->where('type',2)->skip(8)->first();
					@endphp
					<div class="sidebar-add">
						<a href="{{$horizontal8->link}}" target="_blank">
						  <img src="{{asset($horizontal8->ads)}}" alt="$horizontal8->link" />
						</a>
					</div>
				</div>
			</div><!-- /.add-close -->
			...
			<div class="row">
				<div class="col-md-12 col-sm-12">
					@php
					 $horizontal9 = DB::table('ads')->where('type',2)->skip(9)->first();
					@endphp
					<div class="sidebar-add">
						<a href="{{$horizontal9->link}}" target="_blank">
						  <img src="{{asset($horizontal9->ads)}}" alt="$horizontal9->link" />
						</a>
					</div>
				</div>
			</div><!-- /.add-close -->

			<h2>গোপনীয়তা ও নীতি</h2>
			<p class="text-center text-justify" >
			...
			<div class="row">
				<div class="col-md-12 col-sm-12">
					@php
					 $horizontal10 = DB::table('ads')->where('type',2)->skip(10)->first();
					@endphp
					<div class="sidebar-add">
						<a href="{{$horizontal10->link}}" target="_blank">
						  <img src="{{asset($horizontal10->ads)}}" alt="$horizontal10->link" />
						</a>
					</div>
				</div>
			</div><!-- /.add-close -->
		...
		<div class="col-sm-2 col-md-2 col-lg-2">
		   ...
		   <br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
			@php
			 $vertical10 = DB::table('ads')->where('type',1)->skip(10)->first();
			@endphp
			<div class="sidebar-add">
				<a href="{{$vertical10->link}}" target="_blank">
				  <img src="{{asset($vertical10->ads)}}" alt="$vertical10->link" />
				</a>
			</div>

			<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
			@php
			 $vertical11 = DB::table('ads')->where('type',1)->skip(11)->first();
			@endphp
			<div class="sidebar-add">
				<a href="{{$vertical11->link}}" target="_blank">
				  <img src="{{asset($vertical11->ads)}}" alt="$vertical11->link" />
				</a>
			</div>

			<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
			@php
			 $vertical12 = DB::table('ads')->where('type',1)->skip(12)->first();
			@endphp
			<div class="sidebar-add">
				<a href="{{$vertical12->link}}" target="_blank">
				  <img src="{{asset($vertical12->ads)}}" alt="$vertical12->link" />
				</a>
			</div>

			<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
			@php
			 $vertical13 = DB::table('ads')->where('type',1)->skip(13)->first();
			@endphp
			<div class="sidebar-add">
				<a href="{{$vertical13->link}}" target="_blank">
				  <img src="{{asset($vertical13->ads)}}" alt="$vertical13->link" />
				</a>
			</div>
